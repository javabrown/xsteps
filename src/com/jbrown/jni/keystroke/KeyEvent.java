...
public class KeyEvent extends EventObject {
	private static final long serialVersionUID = -7813378547563335435L;
	...
	private boolean _transitionState;
	...
	public boolean equals(KeyEvent event) {
		return event.getVirtualKeyCode() == _virtualKeyCode
				&& event.isExtendedKey() == _extendedKey
				&& event.isAltPressed() == _altPressed;
	}

	@Override
	public String toString() {
		StringBuilder string = new StringBuilder().append(_virtualKeyCode)
				.append(" [").append(_transitionState ? "down" : "up");
		if (_altPressed)
			string.append(",alt");
		if (_shiftPressed)
			string.append(",shift");
