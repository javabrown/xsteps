...
public class StringUtils {
	public static String[] buildStrMatrixWithReplacementCharSet(String str, char[][] charRelacementMatrix) {
		...
		for (char[] set : charRelacementMatrix) {
			...
			String[] mixStrs = StringUtils.relpaceOneByOne(str, set[0],
					set[1]);
	...
	public static boolean compare(String stringToCompare,
			String... possibleVals) {
